...
const AddTruckLoadingAndScreen = ({startLoading, stopLoading, navigation}) => {
            ...
            <View
              ...
              <View
                ...
                <Picker
                  mode="dropdown"
                  style={{}}
                  selectedValue={values.vhclUnloadingWarehouse}
                  onValueChange={(itemValue, itemIndex) =>
                    setFieldValue('vhclUnloadingWarehouse', itemValue)
                  }>
                  {cargoTSO.map(it => (
                    <Picker.Item
                      key={it.id.toString()}
...
export default connectToRedux({
  component: AddTruckLoadingAndScreen,
